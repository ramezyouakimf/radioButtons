...
class RadioButtonRN extends React.Component {
    ...
    render() {
        ...
        let { boxStyle, style, circleSize, textStyle, data, icon, activeColor, deactiveColor, boxActiveBgColor, boxDeactiveBgColor, box, textColor, textSubColor, textSubStyle,disabledColor } = this.props;
                        ...
                        return (
                            ...
                            >
                                <View style={styles.leftProductBox}>
                                    ...
                                    icon && {
                                        backgroundColor: activeIndex === index ? 'transparent' : deactiveColor
                                    }
                                    ]}>
                                        <Animated.View style={{
                                ...
                                <View style={[styles.centerProductBox]}>
                                    <Text style={[{
                                        color: item.disable ? disabledColor : textColor
                                    }, textStyle]}>
                                        {item.label}
                                    </Text>
                                    <Text style={[{
                                        ...textSubStyle,
                                        color: item.disable ? disabledColor : textSubColor
                                    }, textStyle]}>
                                        {item.sub_lable}
                                    </Text>
                                </View>
...
RadioButtonRN.propTypes = {
    ...
    textSubStyle: PropTypes.object,
    textSubColor: PropTypes.string,
    box: PropTypes.bool,
};
